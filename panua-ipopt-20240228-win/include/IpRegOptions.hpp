...
public:
  ...
  RegisteredOption(Index counter)
      : type_(OT_Unknown), advanced_(false), has_lower_(false),
        has_upper_(false), counter_(counter) {}
  ...
  RegisteredOption(
      ...
      : name_(name), short_description_(short_description),
        long_description_(long_description),
        registering_category_(registering_category), type_(OT_Unknown),
        advanced_(advanced), has_lower_(false), has_upper_(false),
        counter_(counter) {}

  RegisteredOption(const RegisteredOption &copy)
      : name_(copy.name_), short_description_(copy.short_description_),
        long_description_(copy.long_description_),
        registering_category_(copy.registering_category_), type_(copy.type_),
        advanced_(copy.advanced_), has_lower_(copy.has_lower_),
        lower_(copy.lower_), has_upper_(copy.has_upper_), upper_(copy.upper_),
        valid_strings_(copy.valid_strings_), counter_(copy.counter_) {}
...
public:
   ...
   */
  virtual void
  SetRegisteringCategory(SmartPtr<RegisteredCategory> registering_category);
   ...
   */
  void
  RegisteredCategoriesByPriority(RegCategoriesByPriority &categories) const;
  ...
  IPOPT_DEPRECATED
  virtual void
  OutputOptionDocumentation(const Journalist &jnlst,
