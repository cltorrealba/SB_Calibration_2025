 ...
 * referenced.
 */
template <class T> class SmartPtr : public Referencer {
public:
#define ipopt_dbg_smartptr_verbosity 0
  ...
  template <class U> SmartPtr(const SmartPtr<U> &copy);
   ...
   */
  template <class U> friend U *GetRawPtr(const SmartPtr<U> &smart_ptr);
   ...
   */
  template <class U> friend bool IsValid(const SmartPtr<U> &smart_ptr);
   ...
   * This is preferred to if(GetRawPtr(sp) == NULL)
   */
  template <class U> friend bool IsNull(const SmartPtr<U> &smart_ptr);
  ///@}
...
///@{
template <class U> U *GetRawPtr(const SmartPtr<U> &smart_ptr);

template <class U> SmartPtr<const U> ConstPtr(const SmartPtr<U> &smart_ptr);

template <class U> bool IsNull(const SmartPtr<U> &smart_ptr);

template <class U> bool IsValid(const SmartPtr<U> &smart_ptr);
...
template <class T> SmartPtr<T>::SmartPtr() : ptr_(0) {
...
template <class T> SmartPtr<T>::SmartPtr(const SmartPtr<T> &copy) : ptr_(0) {
#ifdef IP_DEBUG_SMARTPTR
...
template <class T> SmartPtr<T>::SmartPtr(T *ptr) : ptr_(0) {
#ifdef IP_DEBUG_SMARTPTR
...
template <class T> SmartPtr<T> &SmartPtr<T>::operator=(T *rhs) {
#ifdef IP_DEBUG_SMARTPTR
...
template <class T> SmartPtr<T> &SmartPtr<T>::operator=(const SmartPtr<T> &rhs) {
#ifdef IP_DEBUG_SMARTPTR
...
template <class T> SmartPtr<T> &SmartPtr<T>::SetFromRawPtr_(T *rhs) {
#ifdef IP_DEBUG_SMARTPTR
...
template <class T> void SmartPtr<T>::ReleasePointer_() {
#ifdef IP_DEBUG_SMARTPTR
