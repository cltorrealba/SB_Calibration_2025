...
public:
   ...
   */
  void
  ResortG(const Vector &c, /**< internal activity for equality constraints */
   ...
   */
  void
  ResortBounds(const Vector &x_L, /**< internal values for lower bounds on x */
  ...
  void GetFixedVariables(
      ...
      FixedVariableTreatmentEnum
          &fixed_variable_treatment /**< treatment for fixed variables as used
                                       by TNLP */
  ) const {
