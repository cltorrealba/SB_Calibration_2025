...
public:
   ...
   */
  const SmartPtr<const IteratesVector>
  MakeNewIteratesVector(const Vector &x, const Vector &s, const Vector &y_c,
                        const Vector &y_d, const Vector &z_L, const Vector &z_U,
