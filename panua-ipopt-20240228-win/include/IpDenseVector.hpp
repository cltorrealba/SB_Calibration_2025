...
public:
  ...
  GetStringMetaData(const std::string &tag) const;

  /** Get meta data of type Index by tag */
  inline const std::vector<Index> &
  GetIntegerMetaData(const std::string &tag) const;

  /** Get meta data of type Number by tag */
  inline const std::vector<Number> &
  GetNumericMetaData(const std::string &tag) const;
...
inline const std::vector<std::string> &
DenseVectorSpace::GetStringMetaData(const std::string &tag) const {
...
inline const std::vector<Index> &
DenseVectorSpace::GetIntegerMetaData(const std::string &tag) const {
...
inline const std::vector<Number> &
DenseVectorSpace::GetNumericMetaData(const std::string &tag) const {
...
inline void
DenseVectorSpace::SetStringMetaData(const std::string &tag,
                                    const std::vector<std::string> &meta_data) {
  string_meta_data_[tag] = meta_data;
}

inline void
DenseVectorSpace::SetIntegerMetaData(const std::string &tag,
                                     const std::vector<Index> &meta_data) {
  integer_meta_data_[tag] = meta_data;
}

inline void
DenseVectorSpace::SetNumericMetaData(const std::string &tag,
                                     const std::vector<Number> &meta_data) {
  numeric_meta_data_[tag] = meta_data;
}

inline const StringMetaDataMapType &
...
inline const NumericMetaDataMapType &
DenseVectorSpace::GetNumericMetaData() const {
