...
public:
  ...
  SymLinearSolverFactory(const Journalist &jnlst, const OptionsList &options,
  ...
  AugSystemSolverFactory(const Journalist &jnlst, const OptionsList &options,
                         const std::string &prefix);
  ...
  PDSystemSolverFactory(const Journalist &jnlst, const OptionsList &options,
                        const std::string &prefix);
   ...
   */
  virtual void
  BuildIpoptObjects(const Journalist &jnlst, const OptionsList &options,
                    const std::string &prefix, const SmartPtr<NLP> &nlp,
                    SmartPtr<IpoptNLP> &ip_nlp, SmartPtr<IpoptData> &ip_data,
   ...
   *     -> BuildMuUpdate()
   */
  virtual SmartPtr<IpoptAlgorithm>
  BuildBasicAlgorithm(const Journalist &jnlst, const OptionsList &options,
                      const std::string &prefix);
  ...
  BuildIterationOutput(const Journalist &jnlst, const OptionsList &options,
                       const std::string &prefix);
  ...
  BuildHessianUpdater(const Journalist &jnlst, const OptionsList &options,
                      const std::string &prefix);
  ...
  BuildConvergenceCheck(const Journalist &jnlst, const OptionsList &options,
                        const std::string &prefix);
  ...
  BuildIterateInitializer(const Journalist &jnlst, const OptionsList &options,
                          const std::string &prefix);
